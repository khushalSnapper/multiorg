...
presetup() {
    ...
    pushd ./../../artifacts/src/tracechain/go
...
VERSION="1"
CC_SRC_PATH="./../../artifacts/src/tracechain/go"
CC_NAME="tracechain"
...
approveForMyOrg1() {
    ...
    peer lifecycle chaincode approveformyorg -o 20.221.224.199:7050 \
        --ordererTLSHostnameOverride orderer.example.com --tls \
        --cafile $ORDERER_CA --channelID $CHANNEL_NAME --name ${CC_NAME} --version ${VERSION} \
        --package-id ${PACKAGE_ID} \
        --sequence ${VERSION} --collections-config ../../artifacts/src/tracechain/go/collections_config.json
    # set +x
...
checkCommitReadyness() {
    ...
    peer lifecycle chaincode checkcommitreadiness \
        ...
        --sequence ${VERSION} --collections-config ../../artifacts/src/tracechain/go/collections_config.json --output json
...
commitChaincodeDefination() {
    ...
    peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com \
        ...
        --version ${VERSION} --sequence ${VERSION} --collections-config ../../artifacts/src/tracechain/go/collections_config.json
}
