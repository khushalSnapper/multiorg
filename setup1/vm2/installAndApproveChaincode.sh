...
approveForMyOrg2() {
    ...
    peer lifecycle chaincode approveformyorg -o 20.25.70.69:7050 \
...
checkCommitReadyness() {
    ...
    peer lifecycle chaincode checkcommitreadiness --channelID $CHANNEL_NAME \
        ...
        --name ${CC_NAME} --version ${VERSION} --sequence ${VERSION} --collections-config ../../artifacts/src/tracechain/go/collections_config.json --output json
